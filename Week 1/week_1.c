...
int multiply(int x, int y) {
    ...
    ac = adbc = bd = 0;
    DBG("x = %d : y = %d \n", x, y); 
    /* Base case: if x or y is less than 10 then return x*y */
...
int main(void)
{
    int x = 3141592653589793238462643383279502884197169399375105820974944592;
    int y = 2718281828459045235360287471352662497757247093699959574966967627;
